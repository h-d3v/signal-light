      ...
      <div class="max-w-5xl mx-auto flex flex-wrap p-5 flex-col md:flex-row">
        <div className="flex flex-row items-center justify-between p-3 md:p-1">
          <a href="#" class="flex text-3xl text-white font-medium mb-4 md:mb-0">
            <Image
              src="./images/sg-logo-white.png" // Replace with the path to your image
              alt="Logo"
              width={150} // Adjust as needed
              height={50} // Adjust as needed
              priority // Ensures fast loading for important images like logos
            />
          </a>
          <>
          <div class="text-white pb-4 cursor-pointer leading-none px-3 py-1 md:hidden outline-none focus:outline-none content-end ml-auto">
            <a class="mr-11 pr-2 cursor-pointer  hover:text-white font-semibold tr04" href="#contact">
              Contact
            </a>
          </div>
          </>
        ...
        >
          <div class="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
            <a class="mr-11 pr-2 cursor-pointer text-gray-300 hover:text-white font-semibold tr04" href="#contact">
              Contact
            </a>
          </div>
          {/* <a
